...
class New_Parameter(MDApp):
    ...
    def build(self):
        ...
        pk_list = [el[0] for el in SQL.query(SQL.my_cursor, 'SELECT idWarnings from warnings')]
        ...
        def new(instance):
            SQL.query(SQL.my_cursor, f'DELETE from warnings WHERE idWarnings = {Field1.text}')
            SQL.mydb.commit()
